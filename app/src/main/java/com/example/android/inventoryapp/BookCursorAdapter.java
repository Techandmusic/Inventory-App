...
public class BookCursorAdapter extends CursorAdapter {
    ...
    @BindView(R.id.productName) TextView titleTextView;
    @BindView(R.id.productPrice) TextView priceTextView;
    @BindView(R.id.productQuantity) TextView quantityTextView;
